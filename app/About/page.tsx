...
export default function AboutPage() {
  const schemaData = {
    ...
    "@type": "Organization",
    name: "Remedy International",
    url: "https://theRemedy.com",
    logo: "https://theRemedy.com/logo.png",
    description:
      "Remedy International is a 3D product animation agency serving clients in Miami, Los Angeles, New York, Canada, and the UK.",
    sameAs: [
      "https://www.instagram.com/Remedy",
      "https://www.linkedin.com/company/Remedy",
    ],
    address: {
      "@type": "PostalAddress",
    ...
    <>
      ...
      <section className="py-20 bg-black text-center text-white px-6">
        ...
        <p className="text-lg opacity-80 mb-8">
          Let Remedy International bring your products to life.
        </p>
        <a
          href="/contact"
