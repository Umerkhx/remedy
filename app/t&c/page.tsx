...
export const metadata: Metadata = {
  title: "Terms and Conditions — Remedy",
  description: "Terms and conditions for Remedy 3D animation services.",
  robots: {
    index: false,
    follow: false,
    noarchive: true,
              ...
              <div className="relative space-y-12">
                <header className="space-y-4">
                  ...
                  <p className="text-neutral-400 text-lg">
                    Welcome to Remedy. By accessing our website, you agree to these terms and conditions. Please read
                    them carefully.
                  </p>
                </header>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    These Terms and Conditions govern your use of the Remedy website and services. By using our
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Unless otherwise stated, Remedy owns all the project files. This includes all electronic files,
                    drawings, source files, and any materials provided to the client, which remain the sole property of
                    Remedy International, even if shared.
                  </p>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Remedy will not be liable for any direct, indirect, or consequential loss or damage arising under
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Email:{" "}
                    <a href="mailto:hello@theRemedy.com" className="text-lime-300 underline">
                      hello@theRemedy.com
                    </a>
                  </p>
                </section>
