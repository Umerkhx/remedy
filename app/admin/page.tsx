...
const defaultContent: ContentData = {
  ...
  about: {
    title: "About Remedy International",
  ...
  settings: {
    adminEmail: "admin@theRemedy.com",
    adminPassword: "1234",
  },
}
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const checkAuth = () => {
      ...
      if (sessionCookie && sessionCookie.includes("authenticated")) {
        ...
        const savedContent = localStorage.getItem("Remedy-content")
        if (savedContent) {
        ...
        const savedActivity = localStorage.getItem("Remedy-activity")
        if (savedActivity) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      localStorage.setItem("Remedy-content", JSON.stringify(content))
      ...
      localStorage.setItem("Remedy-activity", JSON.stringify(updatedActivity))
                ...
                <Button
                  ...
                  onClick={() => {
                    if (confirm("Are you sure you want to reset all dashboard data? This cannot be undone.")) {
                      localStorage.removeItem("Remedy-content")
                      localStorage.removeItem("Remedy-activity")
            ...
            <Card className="bg-[#1a1a1a] border-neutral-800">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-neutral-400 text-sm">admin@theRemedy.com</p>
                </div>
                <div>
          ...
          <div className="absolute left-0 top-0 h-full w-64 bg-[#0f0f0f] border-r border-neutral-800">
            <div className="p-6 border-b border-neutral-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-semibold">Remedy</span>
              </div>
