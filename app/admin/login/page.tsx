...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Default credentials
      if (
        (email === "admin@theRemedy.com" && password === "1234") ||
        (email === "Addy@theRemedy.com" && password === "1234")
      ) {
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-600 to-blue-600 p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-semibold text-white">Remedy</span>
          </div>
          <h1 className="text-4xl font-bold text-white mt-12">Welcome to Remedy Admin</h1>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="admin@theRemedy.com"
          ...
          <div className="mt-8 text-center">
            <p className="text-neutral-400 text-sm">
              Need help? Contact{" "}
              <a href="mailto:support@theRemedy.com" className="text-[#C6FF3A] hover:underline">
                support@theRemedy.com
              </a>
            </p>
          </div>
        </div>
