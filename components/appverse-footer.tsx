              ...
              <div className="relative rounded-[28px] liquid-glass p-2 shadow-2xl">
                <div className="relative aspect-[9/19] w-full overflow-hidden rounded-2xl bg-black">
                  ...
                  <LazyVideo
                    ...
                    muted={true}
                    playsInline={true}
                    aria-label="Remedy app preview - approvals made easy"
                  />
                  {/* On-screen content */}
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                <Image src="/icons/skitbit-white.svg" alt="Remedy logo" width={24} height={24} className="h-6 w-6" />
                <span className="text-xl font-semibold text-lime-300">Remedy</span>
              </div>
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      aria-label="Follow Remedy on Twitter"
                    >
                      X/Twitter
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Subscribe to Remedy on YouTube"
                    >
                      YouTube
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Remedy on Instagram"
                    >
                      Instagram
                    </a>
                  </li>
                  <li className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="hover:text-lime-300"
                      aria-label="Follow Remedy on Threads"
                    >
                      Threads
                    </a>
                  </li>
